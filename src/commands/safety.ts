...
import { setSafetyValue } from '../core/config.js';
...
export function safetyCommand(): Command {
  ...
  cmd
    .command('set')
    .description('Set safety guardrail values')
    .argument('<pairs...>', 'key=value pairs (keys: max_fee_bps, max_slippage_bps, max_price_impact_bps, max_trade_sol, allowlist, rpc_allowlist)')
